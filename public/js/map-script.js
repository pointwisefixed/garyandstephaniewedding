	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(38.904927, -77.042720),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
          position: new google.maps.LatLng(38.9032,-77.0530),
          draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
   ...
   /* 
		var marker2 = new MarkerWithLabel({
          position: new google.maps.LatLng(38.8969207,-77.0288447),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
...
*/			
		var marker2 = new MarkerWithLabel({
          position: new google.maps.LatLng(38.8969673,-77.0287986),
          draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
